...
FROM (
	...
	JOIN COMMILVUELOS ON CARRIERCODE = CARRIERCODE_A
	WHERE I1.ID_INCIDENCE IS NULL -- Si es nulo, no existe incidencia (Solo habra 1 entrada, por lo que la incluimos)
